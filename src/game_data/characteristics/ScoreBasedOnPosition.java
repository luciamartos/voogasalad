...
public class ScoreBasedOnPosition implements Characteristic {
	...
	public void execute(Map<Sprite, Side> myCollisionMap) {
		...
		Action myAction = new ScoreAdder((int) Math.max(Math.abs(mySprite.getMyLocation().getXLocation()-initX), Math.abs(mySprite.getMyLocation().getYLocation()-initY)), mySprite);
		myAction.act();
	}
