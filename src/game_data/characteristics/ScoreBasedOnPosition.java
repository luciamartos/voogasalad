...
@CharacteristicAnnotation(name = "Score Based On Position")
public class ScoreBasedOnPosition implements Characteristic{
	...
	public ScoreBasedOnPosition(boolean north, boolean south, boolean east, boolean west, int durability, Sprite aSprite){
...
//				System.out.println("SIDE HIT: "+myCollisionMap.get(collidedSprite));
	...
	public Characteristic copy() {
		return new ScoreBasedOnPosition(breakableNorth, breakableSouth, breakableEast, breakableWest, myDurability, mySprite);
	}
